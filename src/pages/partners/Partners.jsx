...
const partnerLogos = [
  logos, lo, los, loss, logoses, logo, l, football, awesomeassam,
  balipara, cricket, GauhatiTown, haryanatourism, IndianArmy, IncomeTax,
  MarwariYuvaManch, RoadTransport, ScienceandTechnology, MinistryofTourism,
  MinistryofYouth, nectar, NEEPCO, Neramac, Siam, IWT, Theenergy, ios,
  Pernodricard, Toyota, royalenfield, bajaj, gettrade, diageo, macaw,
  shyamsteel, tatapower, Mayfair, rajasthanroyals, greatwhite, satyamgroup,
  marij
];
